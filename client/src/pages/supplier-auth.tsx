...
export default function SupplierAuthPage() {
  ...
  function onRegisterSubmit(values: RegisterValues) {
    // Dodajemo ulogu dobavljača
    console.log("Dobavljač - podaci za registraciju:", values);
    ...
    registerMutation.mutate({
      ...
      city: values.city,
      role: "supplier", // Postavljamo role na supplier
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row">
              ...
              <TabsContent value="register">
                <Form {...registerForm}>
                  <form onSubmit={registerForm.handleSubmit(onRegisterSubmit)} className="space-y-4">
                    <div className="bg-orange-50 p-3 rounded-md mb-4 text-sm text-orange-700 border border-orange-200">
                      <p className="font-medium flex items-center">
                        <Truck className="mr-2 h-4 w-4" />
                        Registracija za dobavljače
                      </p>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input placeholder="Naziv vaše dobavljačke kompanije" {...field} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input 
                              placeholder="kontakt@dobavljac.com" 
                              {...field} 
                              type="email"
                              autoComplete="username" 
                            />
      ...
      <div className="w-full md:w-3/5 bg-orange-600 text-white flex items-center justify-center p-10 hidden md:flex">
        <div className="max-w-lg">
          <h1 className="text-4xl font-bold mb-4">Portal za dobavljače</h1>
          <p className="text-xl mb-6">
            Dobrodošli u portal za dobavljače rezervnih delova. Kao naš partner, 
            možete efikasno upravljati porudžbinama i pratiti njihov status.
          </p>
          <div className="space-y-4">
            <div className="flex items-start">
              <div className="mr-4 bg-white rounded-full p-2 text-orange-600">
                <Truck className="h-6 w-6" />
              </div>
              <div>
                <h3 className="font-bold">Upravljanje porudžbinama</h3>
                <p className="text-orange-100">Pratite i ažurirajte status vaših porudžbina u realnom vremenu.</p>
              </div>
            </div>
            <div className="flex items-start">
              <div className="mr-4 bg-white rounded-full p-2 text-orange-600">
              ...
              <div>
                ...
                <p className="text-orange-100">Vaši podaci su zaštićeni, a pristup imaju samo ovlašćene osobe.</p>
              </div>
            </div>
          </div>
        </div>
